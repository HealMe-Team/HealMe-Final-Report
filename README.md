...
| US-04         | EP-01   | Como turista, quiero recibir una confirmación de compra y detalles de envío, para saber cuándo recibiré mis productos. | - La plataforma muestra un mensaje de confirmación de la compra. <br> - La notificación es visible para el usuario.                                                              |
...
| US-21         | EP-10   | Como usuario, quiero poder ver las características principales de la plataforma, como reservas de citas, compra de medicinas, etc., para entender cómo usar cada funcionalidad. | - Las características principales están descritas con texto representativo.                                                                                                      |
...
|-------------|-------------------|---------------------------------------|---------------------------------------------------------------------------------------------------------------------------|------------------|
| 1           | US-01             |      | Como turista, quiero buscar medicamentos por nombre o categoría, para encontrar el producto que necesito. | 5                |
| 2           | US-02             |      | Como turista, quiero ver la información de cada medicamento (precio y descripción), para tomar una decisión informada antes de comprar.           | 5                |
| 3           | US-03             |      | Como turista, quiero agregar medicamentos a mi carrito de compras, para poder comprar varios artículos a la vez.      | 3                |
| 4           | US-04             |      | Como turista, quiero recibir una confirmación de compra y detalles de envío, para saber cuándo recibiré mis productos.                      | 3                |
| 5           | US-05             |      | Como turista, quiero buscar doctores por especialidad y ubicación, para encontrar un profesional que me pueda atender. | 5                |
| 6           | US-06             |      | Como turista, quiero ver el perfil de cada doctor, con información como calificaciones y reseñas, para seleccionar al mejor doctor disponible. | 3                |
| 7           | US-07             |      | Como turista, quiero ver la disponibilidad de citas de un doctor, para poder reservar una cita acorde a mi horario. | 5                |
| 8           | US-08             |      | Como turista, quiero seleccionar una fecha y hora para mi cita, para elegir el momento que más me convenga.   | 3                |
| 9           | US-09             |      | Como turista, quiero recibir una confirmación de la cita reservada, para tener la certeza de que la cita está programada correctamente.                 | 3                |
| 10          | US-10             |      | Como turista, quiero poder registrarme proporcionando mi correo electrónico, contraseña y datos personales básicos, para crear una cuenta en la plataforma.  | 2                |
| 11          | US-11             |      | Como turista, quiero poder iniciar sesión después de registrarme, para acceder a la plataforma sin tener que registrarme nuevamente.               | 2                |
| 12          | US-12             |      | Como turista quiero elegir centros médicos disponibles para ser atendido.            | 2                |
| 13          | US-13             |      | Como turista quiero ver todos los centros médicos disponibles                | 2                |
| 14          | US-14             |      | Como doctor, quiero ver una lista de mis pacientes con citas pendientes, para estar preparado para las consultas que vienen.               | 2                |
| 15          | US-15             |      | Como doctor, quiero ver los detalles de cada cita (fecha, hora, motivo de la visita), para saber qué esperar de cada consulta.               | 2                |
| 16          | US-16             |      | Como doctor, quiero ver un historial de las citas pasadas, para hacer seguimiento de los tratamientos aplicados a mis pacientes.               | 2                |
| 17          | US-17             |      | Como turista, quiero poder iniciar sesión utilizando mi correo electrónico y contraseña, para acceder a mi cuenta y mis datos personales.               | 2                |
| 18          | US-18             |      | Como doctor, quiero poder iniciar sesión con mi correo electrónico y contraseña, para acceder a mi cuenta y gestionar mis citas.              | 2                |
| 19          | US-19             |      | Como doctor, quiero ver un resumen de las citas pendientes y mis pacientes al iniciar sesión, para estar al tanto de mi agenda.               | 2                |
| 20          | US-20             |      | Como usuario, quiero ver una descripción clara y detallada de la plataforma y sus servicios, para entender cómo funciona y qué beneficios me ofrece.               | 2                |
| 21          | US-21             |      | Como usuario, quiero poder ver las características principales de la plataforma, como reservas de citas, compra de medicinas, etc., para entender cómo usar cada funcionalidad               | 2                |
| 22          | US-22             |      | Como usuario, quiero ver las reseñas de otros usuarios sobre la plataforma, para tomar una decisión informada antes de seleccionar un servicio.               | 2                |
| 23          | US-23             |      | Como usuario, quiero acceder a un formulario de contacto para enviar mis preguntas o inquietudes al equipo de soporte de Heal Me, para obtener asistencia en caso de problemas o dudas.               | 2                |
| 24          | US-24             |      | Como usuario, quiero ver el correo y los números de contacto del equipo de soporte en la página de contacto, para tener una opción de contacto directo si lo prefiero.               | 2                |
| 25          | US-25             |      | Como turista, quiero poder seleccionar el idioma de mi preferencia (español, inglés, etc.) en la aplicación, para utilizar la plataforma de manera más cómoda.             | 2                |
| 26          | US-26             |      | Como doctor, quiero poder cambiar el idioma de la plataforma (español, inglés, etc.), para navegar por la aplicación de forma más sencilla.               | 2                |
| 27          | US-27             |      | Como turista, quiero ver una lista completa de doctores disponibles en la plataforma, para poder elegir al profesional que mejor se adapte a mis necesidades.               | 2                |
| 28          | US-28             |      | Como turista, quiero ver una lista de todos los centros médicos disponibles en la plataforma, para elegir el que más me convenga según su ubicación y servicios.               | 2                |
| 29          | US-29             |      | Como turista, quiero poder filtrar centros médicos por servicios ofrecidos y ubicación, para encontrar el centro adecuado según mis necesidades.               | 2                |
| 30          | US-30             |      | Como usuario, quiero poder volver a la página principal de la plataforma con un solo clic, para navegar fácilmente si me pierdo en el sitio.              | 2                |
| 31          | US-31             |      | Como desarrollador backend, quiero agregar nuevos productos a la base de datos, para mantener el catálogo actualizado.              | 2                |
| 32          | US-32             |      | Como desarrollador backend, quiero editar los detalles de los productos existentes, para actualizar precios o descripciones según sea necesario.               | 2                |
| 33          | US-33             |      | Como desarrollador backend, quiero eliminar productos que ya no están disponibles en la plataforma, para mantener el catálogo limpio y preciso.               | 2                |
| 34          | US-34             |      | Como desarrollador backend, quiero agregar nuevos doctores a la base de datos, para mantener la lista de profesionales actualizada.               | 2                |
| 35          | US-35             |      | Como desarrollador backend, quiero editar la información de los doctores existentes, para corregir errores o actualizar información relevante.              | 2                |
| 36          | US-36             |      | Como desarrollador backend, quiero eliminar doctores que ya no están disponibles en la plataforma, para mantener la base de datos limpia y actualizada.                  | 2                |
| 37          | US-37             |      | Como desarrollador backend, quiero agregar nuevos centros médicos a la base de datos, para mantener la lista de centros actualizada.               | 2                |
| 38          | US-38             |      | Como desarrollador backend, quiero editar la información de los centros médicos existentes, para asegurar que los detalles sean precisos.              | 2                |
| 39          | US-39             |      | Como desarrollador backend, quiero eliminar centros médicos que ya no están disponibles, para mantener la base de datos precisa.               | 2                |
...
4.8.1. Database Diagram
![image alt](./assets/img/base-datos-actualizado.jpg)
## Capítulo V: Product Implementation, Validation & Deployment
